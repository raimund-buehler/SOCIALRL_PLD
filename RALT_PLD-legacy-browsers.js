...
async function experimentInit() {
  ...
  Welcome_head = new visual.TextStim({
    win: psychoJS.window,
    name: 'Welcome_head',
    text: 'Vielen Dank, dass Sie an diesem Experiment teilnehmen!',
    font: font_choice,
    units: undefined, 
  ...
  Welcome_text = new visual.TextStim({
    win: psychoJS.window,
    name: 'Welcome_text',
    text: 'Sie werden im Folgenden aufgefordert, verschiedene \nNummern entweder A oder B zuzuweisen.\n\nSie können dies tun, indem Sie die Pfeiltasten <- \noder -> drücken.\nOb Sie richtig gewählt haben, wird durch Bilder \nangezeigt.\n\nWir beginnen mit einigen Probeläufen,damit Sie das \nExperiment besser verstehen können.\n\n\nDrücken Sie eine beliebige Taste, um fortzufahren!',
    font: font_choice,
    units: undefined, 
  ...
  text_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_3',
    text: 'Am unteren Rand des Bildschirms werden Sie nun \neine Zahl sehen. \nIhre Aufgabe ist es, die Zahl mit den Pfeiltasten \nentweder A oder B zuzuordnen.\n\nDie richtige Zuordnung ist völlig zufällig, Sie \nmüssen also zunächst nur raten.\n\nZusätzlich sehen Sie ein Bild über der Zahl.\nOb du richtig gewählt hast, wird dir durch eine \nVeränderung des Bildes angezeigt.\n\n\nVersuchen wir eine erste Runde!',
    font: font_choice,
    units: undefined, 
    pos: [0, 0], height: 0.025,  wrapWidth: 70, ori: 0,
    languageStyle: 'LTR',
  ...
  feedback_miss = new visual.TextStim({
    win: psychoJS.window,
    name: 'feedback_miss',
    text: 'BITTE ANTWORTEN SIE SCHNELLER!',
    font: font_choice,
    units: undefined, 
  ...
  text_4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_4',
    text: 'Wie Sie gesehen haben, ändert sich das Bild \nabhängig von Ihrer Antwort.\nGlückliche Gesichter zeigen eine richtigen Antwort \nan, wütende Gesichter eine falsche Antwort.\n\nSpäter sollten Sie versuchen, sich an die richtige \nZuordnung der Zahl zu erinnern. \n\nDrücken Sie eine beliebige Taste, um fortzufahren!',
    font: font_choice,
    units: undefined, 
    pos: [0, 0], height: 0.025,  wrapWidth: 70, ori: 0,
    languageStyle: 'LTR',
  ...
  text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: 'Im nächsten Durchgang werden Sie andere Bilder \nsehen. \n\nDas Prinzip bleibt dasselbe.\nDas Bild ändert sich je nach richtiger/falscher \nAntwort.\n\nProbieren wir es aus!',
    font: font_choice,
    units: undefined, 
    pos: [0, 0], height: 0.025,  wrapWidth: 70, ori: 0,
    languageStyle: 'LTR',
  ...
  Allesklartext = new visual.TextStim({
    win: psychoJS.window,
    name: 'Allesklartext',
    text: 'Haben Sie es bemerkt? Im letzten Durchgang stimmten Bild und Text nicht überein!\n\nAber das wird im echten Experiment nur selten passieren.\n\nIm Folgenden werden Sie den Text unten nicht sehen.\n\nVersuchen Sie einfach, so gut Sie können, die richtige Antwort zu geben!',
    font: font_choice,
    units: undefined, 
    pos: [0, 0], height: 0.025,  wrapWidth: 70, ori: 0,
    languageStyle: 'LTR',
  ...
  CycleText1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'CycleText1',
    text: 'Wir beginnen jetzt den ersten Block.\n\nIm ersten Durchgang müssen Sie die Zuordnung \nmit den Pfeiltasten erraten.\nVersuchen Sie, sich die richtige Zuordnung zu \nmerken!\n\nInsgesamt werden Sie 4 verschiedene Zahlen \nsehen.\nDanach gibt es eine kurze Pause.\n\n\nDrücken Sie eine beliebige Taste,\num den ersten Block zu starten.',
    font: font_choice,
    units: undefined, 
  ...
  CycleText2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'CycleText2',
    text: 'PAUSE\n\nDrücken Sie eine beliebige Taste,\num den nächsten Durchgang zu starten.\n\n(A und B könnten die Plätze getauscht haben!)',
    font: font_choice,
    units: undefined, 
    pos: [0, 0], height: 0.025,  wrapWidth: undefined, ori: 0,
    languageStyle: 'LTR',
  ...
  CycleText4 = new visual.TextStim({
    win: psychoJS.window,
    name: 'CycleText4',
    text: 'Sie haben nun einen ganzen Block abgeschlossen.\n\nIm nächsten Block werden Sie andere Bilder sehen.\n\nAnstelle von Häkchen/Kreuzen sehen Sie jetzt Gesichter (oder umgekehrt).\n\nDas Prinzip bleibt das gleiche.\n\nInsgesamt gibt es 4 Blöcke.\n\nWenn Sie bereit sind,\ndrücken Sie eine beliebige Taste,\num den nächsten Block zu starten.',
    font: font_choice,
    units: undefined, 
    pos: [0, 0], height: 0.025,  wrapWidth: undefined, ori: 0,
    languageStyle: 'LTR',
